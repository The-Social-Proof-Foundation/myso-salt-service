...
CREATE INDEX IF NOT EXISTS idx_refresh_token_hash ON refresh_sessions (refresh_token_hash);
...
CREATE INDEX IF NOT EXISTS idx_revoked_user ON revoked_refresh_tokens (user_identifier);
